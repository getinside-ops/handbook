---
title: getinside Handbook — Guide Retail Media
layout: home
description: Guide opérationnel de la plateforme getinside. Retailers, monétisez vos colis et emails. Annonceurs, diffusez vos campagnes sur 250+ e-commerçants.
keywords:
  - retail media
  - monétisation colis
...
hero:
  ...
  actions:
    - theme: brand
      ...
      link: /start-here/
    - theme: alt
      text: Guide de création Sponsored Mail
      link: /advertisers/sponsored-mail/design-guide/

features:
  - icon: 🎯
    title: "Annonceurs : diffusez là où vos clients achètent"
    details: "Retail media off-site : audiences qualifiées via 250+ e-commerçants. 100% de taux de lecture en insertion colis. CTR réseau 2,87% vs 0,90% sur Meta. Conversion 10–30%."
    link: /advertisers/
  - icon: 📦
