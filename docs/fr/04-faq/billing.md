...
<details style="margin-bottom: 10px; border: 1px solid #e1e4e8; border-radius: 6px; padding: 15px;">
 ...
 <ul>
 <li><strong>Sponsored Mail :</strong> Avez-vous rempli votre déclaration de volume hebdomadaire ? (Le lundi/mardi).</li>
...
<details style="margin-bottom: 10px; border: 1px solid #e1e4e8; border-radius: 6px; padding: 15px;">
 <summary style="font-weight: bold; cursor: pointer;">Quels sont les frais sur les retraits de fonds ?</summary>
 <div style="margin-top: 10px; padding-left: 20px; border-left: 2px solid #eee;">
 Les frais dépendent de votre abonnement :
 <ul>
 <li><strong>Starter :</strong> Le premier retrait de l'année est gratuit. Les suivants sont soumis à des frais de gestion de 5%.</li>
 <li><strong>Plateforme & Managed :</strong> Les retraits sont gratuits et illimités.</li>
 </ul>
 </div>
</details>

<details style="margin-bottom: 10px; border: 1px solid #e1e4e8; border-radius: 6px; padding: 15px;">
 <summary style="font-weight: bold; cursor: pointer;">Quels sont les frais en cas d'annulation de campagne ?</summary>
 <div style="margin-top: 10px; padding-left: 20px; border-left: 2px solid #eee;">
 Toute campagne annulée par l'annonceur ou le distributeur après la validation des éléments créatifs (BAT) et opérationnels entraîne des frais de gestion forfaitaires de <strong>550 € HT</strong> dus à getinside.
 </div>
</details>