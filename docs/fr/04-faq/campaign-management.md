...
<details style="margin-bottom: 10px; border: 1px solid #e1e4e8; border-radius: 6px; padding: 15px;">
  ...
  <div style="margin-top: 10px; padding-left: 20px; border-left: 2px solid #eee;">
    ...
    <ul>
      ...
      <li>+ Remboursement des frais de production (si imprimé) et de studio engagés.</li>
    </ul>
  </div>
</details>
...
<details style="margin-bottom: 10px; border: 1px solid #e1e4e8; border-radius: 6px; padding: 15px;">
  ...
  <div style="margin-top: 10px; padding-left: 20px; border-left: 2px solid #eee;">
    ...
    <ol>
      <li>Saisissez "0" dans le reporting de la semaine.</li>
      <li>Prévenez l'annonceur via la messagerie.</li>
    </ol>
