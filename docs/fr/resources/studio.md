...
<div style="border: 1px solid #e1e4e8; border-radius: 8px; overflow: hidden; background: #fff; margin-bottom: 40px;">
  ...
  <div style="padding: 30px; border-bottom: 1px solid #e1e4e8; background-color: #eef2ff; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 20px;">
    <div>
