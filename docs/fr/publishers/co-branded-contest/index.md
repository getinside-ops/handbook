...
<div class="mt-4 mb-6">
  <a href="setup-guide" class="btn btn-primary fs-4">Guide de mise en place</a>
</div>
<hr class="mb-6" />
...
<div style="background: var(--gi-tint-blue-bg); padding: 24px; border-radius: 8px; border-left: 4px solid var(--gi-accent); margin-bottom: 40px;">
  <p class="fs-4 mb-0">
...
<div style="display: flex; flex-direction: column; gap: 20px;">
  ...
  <div style="border: 1px solid var(--vp-c-divider); border-radius: 8px; padding: 24px; background: var(--vp-c-bg-elv); display: flex; align-items: center; gap: 20px;">
    ...
    <div>
      ...
      <p class="fs-2 text-grey-dk-000 mb-0">Vous ne gérez pas l'envoi des lots aux gagnants. C'est l'Annonceur qui s'en charge. Votre responsabilité s'arrête à l'hébergement du jeu.</p>
    </div>
  </div>
</div>