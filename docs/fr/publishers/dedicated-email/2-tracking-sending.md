...
<div style="display: flex; gap: 20px; margin-bottom: 40px;">
  ...
  <div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px; margin-top: 15px;">
      <div style="background: #eef2ff; border: 1px solid #6366f1; padding: 15px; border-radius: 6px;">
...
<div style="display: flex; gap: 20px; margin-bottom: 40px;">
  ...
  <div>
    ...
    <div style="background-color: #fff; border: 2px solid #6366f1; padding: 20px; border-radius: 8px;">
...
<div style="display: flex; gap: 20px; margin-bottom: 40px;">
  ...
  <div>
    ...
    <div style="background-color: #eef2ff; border: 1px solid #e1e4e8; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
