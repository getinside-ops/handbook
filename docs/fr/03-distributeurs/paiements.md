...
<div style="display: flex; gap: 20px; flex-wrap: wrap;">
 ...
 <div style="flex: 1; min-width: 300px; border: 1px solid #7253ed; border-radius: 8px; padding: 24px;">
 ...
 <p>Utilisez votre solde pour financer vos propres campagnes d'acquisition (Sponsored Mail ou Emailing).</p>
 <ul>
