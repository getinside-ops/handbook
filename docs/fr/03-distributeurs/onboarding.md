...
{% include callout.html type="info" title="Paramètres Logistiques" content="**📍 Adresse de l'entrepôt :** Où livrer les flyers ?<br>**⏱️ Lead Time :** Délai entre la réception et le début de l'insertion." %}
{% endcapture %}
...
{% endcapture %}
{% include step.html index="✓" color="green" title="Mise en ligne" content=step6 %}
...
- **💰 Tarif :** Faites une contre-proposition.
- **📅 Planning :** Ajustez les dates selon vos pics de trafic.
- **💬 Chat :** Discutez en direct avec l'annonceur.
{% endcapture %}
