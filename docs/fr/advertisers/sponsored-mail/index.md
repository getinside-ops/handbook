...
<!-- Correction : display grid avec 2 colonnes forcées (1fr 1fr) pour éviter le bug d'alignement -->
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 40px; width: 100%;">

  <!-- CARTE GUIDE COMPLET -->
  <a href="design-guide/" style="text-decoration: none; color: inherit;">
    <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 24px; height: 100%; background: #fcfbff; border-left: 4px solid #7253ed;">
  ...
  <a href="design-guide/strategy" style="text-decoration: none; color: inherit;">
    <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 24px; height: 100%; background: #fff;">
...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; width: 100%;">
  ...
  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background: #fff;">
    ...
    <p class="fs-2 text-grey-dk-000 mb-0">C'est le seul média physique avec un taux de prise en main de 100%.</p>
  </div>

  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background: #fff;">
    <div style="font-size: 30px; margin-bottom: 10px;">🎯</div>
    <strong class="fs-4">Ciblage Affinitaire</strong>
    <p class="fs-2 text-grey-dk-000 mb-0">Associez votre image à des marques dont l'audience correspond à votre persona.</p>
  </div>

  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 20px; background: #fff;">
    <div style="font-size: 30px; margin-bottom: 10px;">🛡️</div>
    <strong class="fs-4">Cookie-less</strong>
    <p class="fs-2 text-grey-dk-000 mb-0">Un levier contextuel puissant, non impacté par le RGPD.</p>
  </div>
