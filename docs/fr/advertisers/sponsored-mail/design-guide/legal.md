...
<div style="border: 1px solid var(--vp-c-divider); border-radius: 8px; padding: 24px; background: var(--vp-c-bg-elv); margin-bottom: 40px;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">
    <div>
      ...
      <span class="fs-2 text-grey-dk-000">Nom social, Forme juridique, Capital, Ville & RCS de l'annonceur.</span>
    </div>
    <div>
      <strong>2. Logos Environnement</strong><br />
      <span class="fs-2 text-grey-dk-000">Cartouche Info-tri (Triman) + Logo getinside (disponibles via le bouton ci-dessus).</span>
    </div>
    <div>
      <strong>3. CGV de l'offre</strong><br />
      <span class="fs-2 text-grey-dk-000">Dates de validité et conditions (ex: "valable dès 50€ d'achat").</span>
    </div>
  </div>
</div>
