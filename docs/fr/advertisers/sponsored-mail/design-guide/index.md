...
<!-- OPTION STUDIO -->
<div style="border: 2px solid #1A7A65; border-radius: 8px; padding: 30px; position: relative; margin-bottom: 40px; background-color: #E8FAF6;">
  <div style="position: absolute; top: -12px; left: 30px; background: #1A7A65; color: white; padding: 2px 12px; border-radius: 12px; font-weight: bold; font-size: 14px;">OPTION STUDIO</div>
