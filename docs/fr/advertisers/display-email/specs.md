  ...
  <table>
    <thead>
      <tr>
        ...
        <th width="30%">Dimensions (L x H)</th>
        <th>Usage fréquent</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><strong>Bannière Large</strong><br><span class="text-grey-dk-000 fs-2">(Leaderboard)</span></td>
        <td><strong>600 x 150 px</strong><br>(parfois 640px de large)</td>
        <td>Header ou Cœur de mail.<br><em>Format le plus impactant.</em></td>
      </tr>
      <tr>
        <td><strong>Pavé</strong><br><span class="text-grey-dk-000 fs-2">(Rectangle)</span></td>
        <td><strong>300 x 250 px</strong></td>
        <td>Colonne latérale ou fin de mail.<br><em>Format compact.</em></td>
      </tr>
    </tbody>
  </table>
</div>
...
<div style="border-left: 4px solid #7253ed; background-color: #fcfbff; padding: 20px; border-radius: 0 8px 8px 0;">
...
<div style="margin-top: 20px; border-left: 4px solid #28a745; background-color: #f0fcf4; padding: 20px; border-radius: 0 8px 8px 0;">
