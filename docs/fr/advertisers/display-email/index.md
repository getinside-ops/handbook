...
<div style="display: flex; flex-direction: column; gap: 20px;">
  ...
  <div style="border: 1px solid #e1e4e8; border-radius: 8px; padding: 24px; background: #fff; display: flex; align-items: center; gap: 20px;">
    ...
    <div>
      ...
      <p class="fs-2 text-grey-dk-000 mb-0">Contrairement au Display programmatique (open web), votre marque s'affiche ici dans un environnement <strong>fermé, sûr et cautionné</strong> par l'éditeur (la marque partenaire).</p>
    </div>
  </div>
