...
<div class="mt-4 mb-6">
  ...
  <a href="specs" class="btn btn-outline fs-4">Specs Bannières</a>
</div>
...
<div style="display: flex; gap: 20px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 250px; border: 1px solid #e1e4e8; border-radius: 8px; padding: 24px; background: #f6f8fa;">
    ...
    <p class="mb-0">Contrairement à l'email dédié, <strong>vous ne fournissez qu'une image</strong>. Pas besoin de coder un email HTML complet.</p>
  </div>

  <div style="flex: 1; min-width: 250px; border: 1px solid #e1e4e8; border-radius: 8px; padding: 24px; background: #f6f8fa;">
    <h3 class="mt-0 text-purple-200">🛡️ Non Intrusif</h3>
    <p class="mb-0">Votre marque s'insère dans un contenu que l'abonné attend, sans perturber sa lecture.</p>
  </div>
