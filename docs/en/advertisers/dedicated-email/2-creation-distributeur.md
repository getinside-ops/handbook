---
title: "Step 2: Production & Co-branding"
description: The retailer designs your email in co-branding — here is how this production phase works.
keywords:
  - email production
  - co-branding
  - endorsement
...
<div class="gi-step">
  ...
  <div class="gi-step-body">
    <h3>Design</h3>
    <p>The retailer (or the getinside Studio) assembles the email using elements from your brief — visuals, offer, wording — within their usual brand style.</p>
  </div>
</div>
...
<div class="gi-step">
  ...
  <div class="gi-step-body">
    ...
    <p>Dynamic tracking links are generated and inserted. The HTML is optimized for deliverability and responsiveness.</p>
  </div>
</div>
...
<div class="gi-step">
  ...
  <div class="gi-step-body">
    ...
    <p>The getinside team checks technical quality before submitting the result for your validation.</p>
  </div>
</div>
...
→ Next step: [Validation & Broadcast](./3-validation-diffusion)
