...
<div class="gi-step">
  ...
  <div class="gi-step-body">
    ...
    <p>Go to <a href="https://app.getinside.media/" target="_blank">app.getinside.media</a>.</p>
  </div>
</div>
...
<div class="gi-step">
  ...
  <div class="gi-step-body">
    <h3>Access the campaign</h3>
    <p>Go to <strong>"My Campaigns"</strong> and select the active campaign.</p>
  </div>
</div>
...
<div class="gi-step">
  ...
  <div class="gi-step-body">
    <h3>Open tracking</h3>
    <p>Open the <strong>"Configuration and tracking"</strong> tab.</p>
  </div>
</div>
